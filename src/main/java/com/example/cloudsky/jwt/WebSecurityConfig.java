    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) ->
                authorizeHttpRequests
                        ...
                        .requestMatchers("/dev/user/**").permitAll() // 'api/user/'로 시작하는 요청 모두 접근 허가
                        .requestMatchers("/dev/post").permitAll() // api/posts 만 허용
                        .requestMatchers(HttpMethod.GET,"/dev/post/**").permitAll() // 해당 url의 get 요청만 허용
